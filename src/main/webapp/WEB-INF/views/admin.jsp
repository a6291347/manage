<%@ page import="com.aahh.common.RequestHolder" %>
<%@ page import="com.aahh.model.SysUser" %>
...
<div id="navbar" class="navbar navbar-default">
    <div class="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a href="<%=request.getContextPath()%>/admin/page.do" class="navbar-brand">
                <small>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            <li class="active">
                <a class="popstyle" href="<%=request.getContextPath()%>/sys/user/page.do" target="_blank">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a class="popstyle" href="<%=request.getContextPath()%>/config/config.page" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            全局配置管理
                        </a>
                        <b class="arrow"></b>
